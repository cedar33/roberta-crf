...
class SentenceLabelingTask(FairseqTask):
    """
    Sentence (or sentence pair) prediction (labeling or regression) task.
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return SentenceLabelingTask(args, data_dict, label_dict)
    ...
    def build_model(self, args):
        ...
        model.register_labeling_head(
            getattr(args, 'labeling_head_name', 'sentence_labeling_head'),
            num_tags=self.args.num_classes,
        )
